...
const formSchema = z.object({
  ...
  reasonForClaim: z.string().min(1, 'Required'),
...
export default function Tier3BenefitClaimForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-6">
      <h1 className="text-2xl font-bold mb-6">Tier 3 Benefit Claim Form</h1>
      <Form {...form}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Enter reason for claim" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
